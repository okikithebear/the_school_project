    ...
    return (
        <div>
            <section className='section'>
                <h1 className='font-semibold text-center text-6xl  text-darkBlue1'>Fo<span className='text-darkgreenVariant'>un</span>der</h1>
                ...
                <div className='container col-md-4   text-justify font-mulish  text-darkBlue1'>
                    ...
                    <h2 className='font-semibold text-2xl mt-1 mb-1'>My Name is <span className='text-darkgreenVariant text-3xl'>Babajide Aina</span> ~</h2>
                    <p>
