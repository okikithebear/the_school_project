...
const Testimonials = () => {
  return (
    ...
    <div class="container mx-auto max-w-7xl p-2 md:10">
      
      <div class="grid gap-6 grid-cols-1 text-white md:grid-cols-4 md:grid-rows-2">
      
        <div class="relative p-10 rounded-xl bg-green-400 md:col-span-2">
     
          <img
            src="images/bg-pattern-quotation.svg"
            alt=""
            class="absolute top-3 right-8 scale-125 md:top-7 md:right-24 md:scale-150"
          />
          ...
          <div class="flex z-10 space-x-4">
            <img
              ...
              alt=""
              class="w-12 h-12 rounded-full ring-3 ring-purple-300 hover:scale-110"
            />
            <div class="text-sm">
              <h4 class="opacity-90">Sharon </h4>
          ...
          <p class="mt-6 opacity-50 line-clamp-6">
            ...
            <div class="p-10 rounded-xl bg-darkBlue">
            ...
            <div class="hidden p-10 rounded-xl text-slate-800 bg-green-400 md:block md:row-span-2">
...
<div class="p-10 rounded-xl text-white bg-darkBlue">
 ...
 <div class="p-10 rounded-xl bg-darkBlue text-white md:col-span-2">
  ...
  <p class="mt-6 opacity-50">
   "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minus unde dicta earum necessitatibus, maiores commodi inventore ipsam sapiente porro explicabo excepturi delectus dolorem alias rem?"
      ...
      <div class="p-10 rounded-xl text-slate-800 bg-white md:hidden">
        <div class="flex space-x-4">
          <img
