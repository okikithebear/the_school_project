...
const MobileTestimonial = () => {
    return (
        <div className={"testimonial-card relative w-full"}>
                <div className="w-100 p-10 rounded-xl bg-darkgreenVariant">
                ...
                {/*        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe commodi magni quo fugit quae*/}
                {/*        maxime suscipit voluptas dolorum id provident."*/}
                {/*    </p>*/}
                {/*</div>*/}
                ...
                {/*    <p className="mt-6 opacity-50">*/}
                {/*        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, cum accusamus error*/}
                {/*        consequatur, ullam quidem voluptate quas fugiat ab doloremque sed! Qui nostrum recusandae*/}
                {/*        voluptatum itaque culpa, soluta corrupti ratione!""*/}
                {/*    </p>*/}
                {/*</div>*/}
                ...
                {/*    <p className="mt-6 opacity-50">*/}
                {/*        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aliquam porro, ex doloribus*/}
                {/*        optio nemo"*/}
                {/*    </p>*/}
                {/*</div>*/}
                ...
                {/*    <p className="mt-6 opacity-50">*/}
                {/*        "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minus unde dicta earum*/}
                {/*        necessitatibus, maiores commodi inventore ipsam sapiente porro explicabo excepturi delectus*/}
                {/*        dolorem alias rem?"*/}
                {/*    </p>*/}
                {/*</div>*/}
                ...
                {/*    </p>*/}
                {/*    <p className="mt-6 opacity-50">*/}
                {/*        "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorum itaque officiis doloribus*/}
                {/*        veritatis debitis laudantium. Sint quidem similique repellendus quaerat et illo ipsam animi*/}
                {/*        soluta."*/}
                {/*    </p>*/}
                {/*</div>*/}
