        ...
        <div className={'px-4 md:px-10'}>
            <section className='section'>
                <div className="container-fluid flex flex-col p-2 md:p-6 lg:flex-row lg:mb-0 font-mulish">
                    ...
                    <div className="basis-1/2 md:my-auto lg:w-1/2 flex-wrap">
                        ...
                        <p className="px-3 text-lg italic text-slate-500 w-full md:w-5/6 -mt-4 mx-4">
                            ...
                            <span>You can teach a student a lesson for a day; but if you can teach him to learn by creating
                ...
                <div className='flex flex-col p-2 md:p-10  text-justify font-mulish text-darkBlue1'>
                    <h4  className='font-bold text-2xl md:text-3xl text-darkgreenVariant'>Hello!</h4>
                    <span className='font-semibold text-xl md:text-2xl mt-1 mb-1 tracking-tight	'>
                        My Name is
                        <span className='text-darkgreenVariant text-xl md:text-2xl'> Emmanuel Fakolade</span> ~
                    </span>
                    <p>
