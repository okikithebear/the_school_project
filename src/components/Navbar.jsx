                            ...
                            <div key={link.name}>
                                {link.name === "About Us" ?
                                    ...
                                    <li key={link.name} className='flex md:ml-8 text-xl'
                                        onMouseEnter={() => width > 768 ? "" : setIsOpen(true)}>
                                        <NavLink to={link.link} className='hover:text-darkgreenVariant'>
                                            {link.name}
                                        </NavLink>
                                    </li>
...
const AlternateNavbar = () => {
    ...
    return (
        <>
            <nav
                className='md:flex navbar-alt sticky top-4 z-20 overflow-hidden items-center justify-between bg-darkBlue p-4 font-mulish text-white'>
                <div className='font-semibold text-xl cursor-pointer text-darkgreenVariant'>
                    Light Workers Academy
                </div>
